    ...
    <div class="container p-8 mx-auto bg-white">
        ...
        <form class="mt-8"
            ...
            <div class="flex items-start mt-4">
                ...
                <select name="category"
                    ...
                    <option value="Navigation"
                        {{$component->category === "Navigation" ? 'selected':''}}>Navigation
                    </option>
                    <option value="Form Inputs"
                        {{$component->category === "Form Inputs" ? 'selected':''}}>Form Inputs
                    </option>
                    <option value="UI Elements"
                        {{$component->category === "UI Elements" ? 'selected':''}}>UI Elements
                    </option>
                </select>
            </div>
            @error('category')
            ...
            <div class="flex items-center justify-end w-full mt-4">
                ...
                <button type="submit"
                        class="p-2 text-white bg-blue-500 rounded">Save
                </button>
            </div>
